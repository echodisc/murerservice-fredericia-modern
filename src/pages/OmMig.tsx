    ...
    <main>
      ...
      <div className="bg-background px-6 lg:px-16 pt-6">
        <div className="max-w-5xl mx-auto">
          <Link to="/" className="text-primary text-[15px] hover:underline">
      ...
      <section className="bg-card py-16 px-6 lg:px-16">
        <div className="max-w-5xl mx-auto">
          <h2 className="font-semibold text-foreground text-2xl md:text-3xl text-center mb-12">25 år i murerfaget</h2>
          <div className="relative">
            ...
            <div className="flex flex-col gap-10">
              {milestones.map((m, i) => (
                <div
                  key={m.year}
                  className={`relative flex flex-col lg:flex-row items-start lg:items-center gap-4 ${i % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"}`}
                >
      ...
      <section className="bg-card py-16 px-6 lg:px-16">
        <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center gap-12">
          <div className="w-full lg:w-[55%] flex flex-col gap-4">
            <h2 className="font-semibold text-foreground text-2xl md:text-3xl">Stolthed i hvert projekt</h2>
            <p className="text-muted-foreground text-[16px] leading-relaxed">
              Uanset om det er en lille reparation eller en komplet renovering, behandler jeg hvert projekt med samme
              omhu. Jeg arbejder primært i Kolding, Vejle, Fredericia og resten af Trekantområdet — men tager også gerne
              opgaver lidt længere væk, hvis projektet er det rigtige.
            </p>
            <p className="text-muted-foreground text-[16px] leading-relaxed">
              Jeg samarbejder tæt med mine kunder undervejs, og du er altid velkommen til at kigge forbi byggepladsen.
              Åbenhed og dialog er en del af måden jeg arbejder på.
            </p>
          ...
          <div className="w-full lg:w-[45%]">
            <img
              src={profilImg}
              alt="Murermester Mogens Larsen — ML Murerservice"
              loading="lazy"
              width={800}
              height={800}
