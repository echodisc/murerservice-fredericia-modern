  ...
  return (
    <div className="relative group">
      ...
      <button
        ...
        className="absolute left-3 top-1/2 -translate-y-1/2 z-20 bg-background/80 backdrop-blur-sm rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity shadow"
      >
